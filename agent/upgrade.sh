...
# anchor — the pinned preflight sha256, the baked pubkey, the v0.2.2.2026.08.22.42f5f89c
...
# URL we advertise. A conditional render would put a "does agent have a ladder"
...
#
# DO NOT EDIT generated copies (agent/install.sh, agent/upgrade.sh) by hand —
...
MIN_VERSION="v0.2.2.2026.08.22.42f5f89c"
