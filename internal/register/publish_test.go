...
func TestPublishHappyPath(t *testing.T) {
	...
	p := &fakePutter{}
	err := Publish(context.Background(), PublishDeps{ConsoleURL: "https://c.example", HTTP: g, R2: p}, "cli", "")
	if err != nil {
...
func TestPublishRelayRefused(t *testing.T) {
	err := Publish(context.Background(), PublishDeps{ConsoleURL: "https://c.example", HTTP: &fakeGetter{}, R2: &fakePutter{}}, "relay", "")
