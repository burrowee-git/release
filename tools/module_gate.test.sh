...
for red in test-r2-fallback.sh test-e2e-relay.sh test-upgrade-bootstrap.sh test-e2e.sh sync-modules.sh; do
    check_lacks "known-red/unsafe suite not wired: ${red}" " ${gate_list} " " ${red} "
done
