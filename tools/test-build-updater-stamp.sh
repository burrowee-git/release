...
pin_case v0.3.0+build.7 REFUSE "build metadata is not a tag — internal/relconfig refuses it too"
pin_case v0.3.0-dirty "v0.3.0.dirty.2026.08.30.01234567" "a plain alphanumeric pre-release is a tag, and renders dotted"
