...
#
# Deliberately NOT wired: test-r2-fallback.sh, test-e2e-relay.sh and
# test-upgrade-bootstrap.sh are red on main, predate the modules work, and are
# tracked separately — wiring them would block every cut. The gate set here is
# the green set, on purpose. If you make one of those pass, wire it here in the
